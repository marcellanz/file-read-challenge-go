...
// Variation7.go rev16 (64k entry-chunks mutex, common-name + date in loop + sync.Pool) on my mac: 9.8s (min)... 10.0 - 10.5

// Variation7.go rev17 (64k entry-chunks mutex, rev16 + regex bug) on my mac: 9.15 (min)
// Variation7.go rev17 (64k entry-chunks mutex, rev16 + simpler regex) on my mac: 8.32 (min) 8.7..9.2
